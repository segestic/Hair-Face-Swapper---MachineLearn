...
class FaceSwap:
    ...
    def __init__(self, image1, image2):
        ...
        path = "." + "/media/" + f'{i1}-{i2}.jpg' 
        # os.path.join(os.getcwd(), 'jjj', 'output', f'{i1}-{i2}.jpg')
        print(path)
...
if(__name__ == '__main__'):
    # img1 = './data/hairstyle2.jpg'
    # img2 = './data/hairstyle3.jpg'
    img1 = "." + "/media/" + "hairstyle1.jpg"
    img2 = "." + "/media/" + "hairstyle2.jpg"
